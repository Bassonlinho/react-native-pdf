...
| useBestQuality                 |                             bool                              |          false           | Android only. Switch bitmap rendering from RGB_565 to ARGB_8888 for higher quality at higher memory cost.                                                                    | ✖   | ✔       | ✖                           | unreleased               |
| enableRenderDuringScale        |                             bool                              |          false           | Android only. Re-render while pinch zoom is in progress for smoother visual updates during scaling.                                                                           | ✖   | ✔       | ✖                           | unreleased               |
