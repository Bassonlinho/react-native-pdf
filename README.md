...
| useAndroidPdfRenderer          |                             bool                              |          false           | Android only. Use the JS fallback viewer backed by `android.graphics.pdf.PdfRenderer` instead of the default AndroidPdfViewer renderer. Useful for renderer-specific blur issues. | ✖   | ✔       | ✖                           | unreleased               |
